...
#       bash, then change the shebang line above to use that shell, or create
#       a wrapper script and invoke that instead.
#
#   (2) The slurping of all output in this script is necessary to make sure
#       all the output of the commands invoked in the shell script itself is
#       buffered in memory instead of being immediately flushed to stdout.
#
##############################################################################
...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    for arg in "$@" ; do
        ...
        if [ $CHECK -ne 0 ] && [ $CHECK2 -eq 0 ] ; then                    ### Added a localized path
